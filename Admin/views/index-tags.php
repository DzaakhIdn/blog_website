...
$length = count($tag->all()); // Total data
...
$tags = $tag->all_paginate($offset, $limit);
?>
...
<head>
  ...
  <title>Tags | PlainAdmin Demo</title>
                    ...
                    <tbody>
                      <?php foreach ($tags as $tag): ?>
                        <tr>
                          ...
                          <td>
                            <button href="#" data-id="<?= $tag['tags_id'] ?>" class="hapus btn btn-danger"><i class="fa-solid fa-trash"></i></button>
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      $('#search-input').on('keyup', function() {
        $('#bungkus-table').load(`../search/search_tag.php?keyword=` + $('#search-input').val());
      });
      ...
      $('.hapus').click(function() {
        ...
        Swal.fire({
          ...
          text: "Bebas sih mau hapus apa engga",
          icon: "warning",
